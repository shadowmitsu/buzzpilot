                                                ...
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    ...
                                                    <div
                                                        ...
                                                        <h2
                                                            ...
                                                            Hey {{ $user->full_name }},</h2>
                                                            <p>Terima kasih telah mendaftar akun di SSM Panel! 
                                                                Kamu adalah pengguna yang sangat spesial di antara banyak pengguna lainnya.
                                                            </p>
                                                            <p>Sebelum memulai, kami memerlukan kamu untuk memverifikasi email terlebih dahulu.</p>
